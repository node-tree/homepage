  ...
  return (
    <div className="team-page">
      ...
      <div className="team-container">
        ...
        >
          <p>
            보존과학·설치미술·사운드아트·라이브 코딩이 교차하는 다학제 프로젝트.
            충남 서해안 간척지에서 수집한 폐어망·부식 금속·해양 폐기물을 재직조하여
            거대한 그물 기둥(Net Pillar)을 세우고, 보존과학 분석을 통해 부식층의
            광물 조성·열화 등급·색채 스펙트럼이 빛과 소리의 언어로 변환됩니다.
          </p>
        </motion.div>
