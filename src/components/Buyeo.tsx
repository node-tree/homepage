...
const BUYEO_STOPS: BuyeoStop[] = [
  {
    stop: 1,
    place: '장소 1',
    subtitle: '동선상 첫 번째 도착지',
    guide: [
      '부여의 첫 번째 장소에 도착하셨습니다.',
  ...
  },
  {
    stop: 2,
    place: '장소 2',
    subtitle: '오늘을 안고 돌아가는 길',
    guide: [
      '오늘, 무언가가 내 안에 쌓였습니다. 두께가 생겼습니다.',
      '역사의 두께도 아니고, 풍경의 두께도 아닌— 내가 오늘 이 도시를 통과하면서 생겨난 두께.',
      '그 겹과 겹 사이에서, 다섯 개의 단어를 길어 올리셨나요. 그 단어들이 지금, 어떤 울림으로 남아 있는지 기억하고 계신가요.',
      '오늘의 악보는, 완성되었습니다. 창과 나 사이로, 이제는 떠나온 풍경이 스쳐 지납니다.',
      '부여를 두고 가는 것이 아닙니다. 오늘의 두께를, 겹을, 그 다섯 개의 단어를 안에 담아 가는 겁니다.',
      '지금부터 마지막 음악을 들려드리겠습니다. 음악이 흐르는 동안, 돌아가는 길 내내 오늘 하루를 가만히 되감아 보세요. 그 안에, 당신만의 부여가 있습니다.',
    ],
