...
function buildChulgangMessages({ program, 회차, 교육주제, 주제출처, 계획, 회차맥락, 키워드 }) {
  ...
  const user = [
    ...
    ENRICH_RULE,
    '',
    '위 정보에만 근거해 출강확인서의 교육주제와 본문을 작성하라. 아래 JSON 형식으로만 출력한다:',
    '{"교육주제":"…","교육목표":"…","세부내용":"…","교육재료":"…","평가_운영":"…","평가_반응":"…","평가_보완":"…"}',
    ...
    '나머지 6항목(교육목표·세부내용·교육재료·평가 3종)은 위 교육주제와 일관되게 작성하라.',
