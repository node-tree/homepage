...
const GENERAL_SUPPLY_SUBITEMS = [
  ...
  { key: '원고료', label: '원고료', amount: 1750000, isPersonnelActivity: false, formula: '일반원고 15,000원×50매 + 자료편집 5,000원×200매' },
  {
    ...
    breakdown: [
      { program: '신규가 장암책정', programKey: 'jangam-chaekjeong', amount: 8737850, detail: '합판18mm 1,809,000 + 합판12mm 400,000 + 각목38×89 360,000 + 각목38×38 160,000 + 수성페인트 900,000 + 우드스테인 344,000 + 코팅재 240,000 + 사포 250,000 + 붓 150,000 + 롤러트레이 150,000 + 목공피스 300,000 + 목장갑 100,000 + 샌딩기 410,000 + 경첩·부속 292,000 + 액자·디스플레이 405,000 + LED조명 960,000 + 시판넬·캡션 800,000 + 인터뷰액자 500,000 + 마감재 207,850' },
      { program: '신규다 기억순환', programKey: 'gieok-sunhwan', amount: 400000, detail: '전시 디스플레이 자재' },
      { program: '기존가 손의기억', programKey: 'son-gieok', amount: 2260000, detail: 'A형 도구 210,000 + B형 도구 1,750,000 + 공동 도구함 300,000' },
      { program: '기존나 소리일기', programKey: 'sori-ilgi', amount: 716300, detail: '결과물 재료' },
      { program: '기존다 풍경일기', programKey: 'punggyeong-ilgi', amount: 544000, detail: '휴대용 화판 144,000 + 색재료 400,000' },
      { program: '축제 다시안녕', programKey: 'dasi-annyeong', amount: 200000, detail: '체험부스 재료' },
    ],
  },
